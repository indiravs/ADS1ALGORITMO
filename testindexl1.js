...
function callIndex1(){
var questao=prompt(`Digite o número da questão escolhida, ou 0 para retornar ao menu principal: 
`);
...
if (questaon==0){
    ...
    //console.log('Exercício não existente. Por favor digite um número entre 1 e 25.')
   // }
switch(questaon){
    case 1:
...
var questao2=prompt(`Digite o número da questão escolhida, ou 0 para retornar ao menu principal: 
`);
var questaon2=Number(questao2);
if (questaon2==0){
    var mainmenu=require('./testmenu.js');
    delete require.cache[require.resolve(`./testmenu`)]
    console.log(mainmenu);
}else if(questaon2>40){
    console.log('Exercício não existente. Por favor digite um número entre 1 e 25.')
    }
callIndex1();
