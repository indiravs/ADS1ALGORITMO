...
`)
var lista=prompt(`Escolha uma das opções abaixo: 
...
if (Number(lista)>3){
    console.log('Lista não existente. Por favor digite um número de 1 a 3 para selecionar uma lista, ou 0 para encerrar o programa.')
